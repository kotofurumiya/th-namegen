...
var kaeizuka_default = data11;

// src/character/009_05_bunkachou.ts
var characters12 = [];
var data12 = {
...
var seirensen_default = data16;

// src/character/012_03_hisoutensoku.ts
var characters17 = [];
var data17 = {
  characters: characters17,
  releasedYear: 2009,
  titleNumber: 12.3,
  tags: ["windows", "tasofro"]
};
var hisoutensoku_default = data17;
...
var doublespoiler_default = data18;

// src/character/012_08_youseidaisensou.ts
var characters19 = [];
var data19 = {
  characters: characters19,
  releasedYear: 2010,
  titleNumber: 12.8,
  tags: ["windows"]
};
var youseidaisensou_default = data19;
...
var shinreibyou_default = data20;
...
var tenkuushou_default = data26;

// src/character/016_05_hifuunightmarediary.ts
var characters27 = [];
var data27 = {
  characters: characters27,
  releasedYear: 2018,
  titleNumber: 16.5,
  tags: ["windows"]
};
var hifuunightmarediary_default = data27;
...
var allTitleData = [
  ...
  chireiden_default,
  seirensen_default,
  hisoutensoku_default,
  doublespoiler_default,
  youseidaisensou_default,
  shinreibyou_default,
  shinkirou_default,
  kishinjou_default,
  shinpiroku_default,
...
// src/filter/index.ts
var oneOfTitleTags = (tags) => {
  return (character, title) => {
    return tags.some((t) => title.tags.includes(t));
  };
};
var noneOfTitleTags = (tags) => {
  return (character, title) => {
    return !tags.some((t) => title.tags.includes(t));
  };
};
...
var selectCharacters = (filters = [], options = {}) => {
  const allCharacters2 = (options.titles || allTitleData).flatMap((title) => title.characters.map((character) => ({
    title,
    character
  })));
  const selected = filters.reduce((prev, f) => prev.filter((char) => f(char.character, char.title)), allCharacters2).map((char) => char.character);
  return selected;
};
...
var allCharacters = selectCharacters();
var generateName = (options = {}) => {
  ...
  const candidates = (_c = options.characterCandidates) != null ? _c : allCharacters;
